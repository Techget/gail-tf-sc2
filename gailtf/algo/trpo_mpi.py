...
def learn(env, policy_func, discriminator, expert_dataset,
        ...
        clip_param=0.005, adam_epsilon=3e-4,
        optim_epochs=1, optim_stepsize=2e-4, optim_batchsize=32,schedule='linear'
        ):
    ...
    while True:        
        ...
        if schedule == 'constant':
            ...
            cur_lrmult =  max(1.0 - float(timesteps_so_far) / (max_timesteps+1e7), 0.1) # make the smallest number as 0.1 instead of 0
        else:
